...
<head>
    ...
    <!-- BASE CSS -->
    <link href="{{ URL::asset('theme/css/bootstrap_customized.min.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('theme/css/style.css') }}" rel="stylesheet">

    <!-- SPECIFIC CSS -->
    <link href="{{ URL::asset('theme/css/listing.css') }}" rel="stylesheet">
...
<script src="{{ URL::asset('theme/js/common_scripts.min.js') }}"></script>
<script src="{{ URL::asset('theme/js/common_func.js') }}"></script>
